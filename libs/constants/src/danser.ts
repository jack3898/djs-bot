// These settings were generated by the danser application and has been modified a little bit. The shape of the object is the same as the danser application's settings file.
// It is expected this config file will be clones and modified programmatically to create new settings files for different users.

export const danserDefaultConfig = {
    General: {
        OsuSongsDir: '<SPECIFY>',
        OsuSkinsDir: '<SPECIFY>',
        OsuReplaysDir: '<SPECIFY>',
...
export type DanserDefaultConfig = typeof danserDefaultConfig;
